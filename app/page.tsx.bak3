        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="relative h-[420px] md:h-[520px]">
              <div className="absolute top-0 left-0 w-[65%] h-[70%] rounded-2xl overflow-hidden shadow-xl">
                <Image
                  src="/media/11.jpg"
                  alt="Cabana Aventurin - exterior"
                  fill
                  className="object-cover"
                  sizes="(max-width: 768px) 60vw, 30vw"
                />
              </div>
              <div className="absolute bottom-0 right-0 w-[55%] h-[55%] rounded-2xl overflow-hidden shadow-xl border-4 border-white dark:border-gray-950">
                <Image
                  src="/media/12.jpg"
                  alt="Cabana Aventurin - interior"
                  fill
                  className="object-cover"
                  sizes="(max-width: 768px) 50vw, 25vw"
                />
              </div>
              <div className="absolute top-[30%] right-[10%] w-[35%] h-[30%] rounded-2xl overflow-hidden shadow-lg border-4 border-white dark:border-gray-950">
                <Image
                  src="/media/13.jpg"
                  alt="Cabana Aventurin - natură"
                  fill
                  className="object-cover"
              ...
              {/* Decorative element */}
              <div className="absolute -bottom-4 -left-4 w-28 h-28 bg-forest-100 dark:bg-forest-900 rounded-2xl -z-10" />
            </div>
