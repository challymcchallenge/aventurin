          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
              {[
                ...
                <div
                  key={item.title}
                  className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm text-left"
                >
      ...
      <section className="py-20 md:py-28">
        <div className="container-custom max-w-3xl">
          ...
          <div className="space-y-4">
            {[
              {
                q: 'Câte persoane pot fi cazate la cabană?',
                a: 'Cabana poate găzdui între 20 și 100 de persoane, în funcție de configurația aleasă — cazare overnight sau doar eveniment de zi.',
              },
              {
                q: 'Pot închiria doar o parte din cabană?',
                a: 'Da! Oferim flexibilitate maximă. Poți închiria cabana integrală sau parțial, în funcție de buget și nevoi.',
              },
              {
                q: 'Este catering-ul inclus în prețuri?',
                a: 'Catering-ul este opțional și se adaugă la cerere. Avem meniuri de la mic dejun simplu până la banchet complet, cu produse locale.',
              },
              {
                q: 'Cum se fac rezervările?',
                a: 'Ne poți contacta prin formularul de pe pagina Contact, direct pe WhatsApp sau telefonic la +40 724 771 278. Confirmăm disponibilitatea și stabilim detaliile împreună.',
              },
              {
                q: 'Câine/pisică poate veni cu noi?',
                a: 'Absolut — animalele de companie sunt binevenite! Te rugăm să ne anunți în avans.',
              },
            ].map((item) => (
              <details
                key={item.q}
                className="group bg-white dark:bg-gray-800 rounded-2xl shadow-sm overflow-hidden"
              >
                ...
                <div className="px-6 pb-6 text-gray-600 dark:text-gray-300 text-sm leading-relaxed">
                  {item.a}
                </div>
              </details>
            ))}
