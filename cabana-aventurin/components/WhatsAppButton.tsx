...
export function WhatsAppButton() {
  ...
  return (
    <a
      href="https://wa.me/40724771278?text=Bună!%20Aș%20dori%20să%20fac%20o%20rezervare%20la%20Cabana%20Aventurin."
      target="_blank"
      rel="noopener noreferrer"
      aria-label="Contactează-ne pe WhatsApp"
      onMouseEnter={() => setHovered(true)}
      onMouseLeave={() => setHovered(false)}
      className="fixed bottom-6 right-6 z-50 flex items-center gap-2.5 bg-green-500 hover:bg-green-600 text-white rounded-full shadow-xl hover:shadow-2xl transition-all duration-300 group"
      style={{
